	...
	return (
		...
		`}>
			...
			<div className='box-video'>
				<div>
					<video src={dataModal.srcs ? dataModal.srcs[1].srcMp4 : ''} autoPlay controls loop />
				</div>
				{dataModal.aboutContent}
			</div>
			<div className='buttons'>{
				dataModal.repos ? dataModal.repos.map(data => {
					...
					return (
						<Button key={Object.values(data)[0]} data={data} />
					);
				}) : ''
			}</div>
			<button onClick={() => {
